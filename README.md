...
--still do this part have to add in the workflows and in a .yml file?? i think in a seperate folder to do it. do the jobs in a runner (virtual machine) not sure exactly what to do to set up my stats I think i can leave the snake alone and still looks cool might have to set it up though (rewatch video)
